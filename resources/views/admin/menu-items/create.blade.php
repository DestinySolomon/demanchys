...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add New Menu Item</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.menu-items.store') }}" method="POST" enctype="multipart/form-data" id="menuItemForm">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Recommended: 500x500px, max 5MB</div>
                    </div>
                </div>

...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Takeaway Orders</h1>
        <div class="btn-group">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Takeaway Orders ({{ $orders->total() }})</h6>
        </div>
        <div class="card-body">
            @if($orders->count() > 0)
            ...
            <div class="text-center py-5">
                ...
                <h4 class="text-muted mt-3">No Takeaway Orders</h4>
                <p class="text-muted">There are no takeaway orders at the moment.</p>
            </div>
            @endif
        </div>
    </div>

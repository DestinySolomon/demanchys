...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ongoing Events</h1>
        <div class="btn-group">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Ongoing Events ({{ $events->total() }})</h6>
        </div>
        <div class="card-body">
            @if($events->count() > 0)
                        ...
                        <tr>
                            ...
                            <td>
                                @if($event->contact_phone)
                                    <small>{{ $event->contact_phone }}</small>
                                @else
            ...
            <div class="text-center py-5">
                ...
                <h4 class="text-muted mt-3">No Ongoing Events</h4>
                <p class="text-muted">There are no events happening right now.</p>
            </div>
            @endif
        </div>
    </div>

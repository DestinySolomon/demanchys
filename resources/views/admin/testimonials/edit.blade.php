                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="rating" name="rating" required>
                                        <option value="5" {{ old('rating', $testimonial->rating) == 5 ? 'selected' : '' }}>★★★★★ - Excellent (5)</option>
                                        <option value="4" {{ old('rating', $testimonial->rating) == 4 ? 'selected' : '' }}>★★★★☆ - Very Good (4)</option>
                                        <option value="3" {{ old('rating', $testimonial->rating) == 3 ? 'selected' : '' }}>★★★☆☆ - Good (3)</option>
                                        <option value="2" {{ old('rating', $testimonial->rating) == 2 ? 'selected' : '' }}>★★☆☆☆ - Fair (2)</option>
                                        <option value="1" {{ old('rating', $testimonial->rating) == 1 ? 'selected' : '' }}>★☆☆☆☆ - Poor (1)</option>
                                    </select>
                                    @error('rating')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
    ...
    document.getElementById('image').addEventListener('change', function(e) {
        ...
        if (this.files && this.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                info.textContent = `New photo: ${this.files[0].name} (${Math.round(this.files[0].size / 1024)} KB)`;

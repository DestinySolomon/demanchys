...
<ul class="list-unstyled mb-0">
    <!-- Dashboard -->
    <li class="mb-1">
        <a href="{{ route('dashboard') }}" class="sidebar-menu-item active" data-title="Dashboard Overview">
    ...
    <!-- Manage Menu -->
    <li class="mb-1">
        <a class="sidebar-menu-item" data-bs-toggle="collapse" href="#menuCollapse" data-title="Manage Menu">
    ...
    <!-- Manage Orders -->
    <li class="mb-1">
        <a class="sidebar-menu-item" data-bs-toggle="collapse" href="#ordersCollapse" data-title="Manage Orders">
